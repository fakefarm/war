  ...
  class CombatController < ApplicationController
    ...
    swagger_path '/v1/combat' do
      operation :get do
        ...
        key :description, 'choose players from the Marvel Universe, and a random number between 1 and 9. Response will select a term from each player\'s description. The winner is the player with the word that is either a SUPER WORD, or the longest word. SUPER Words defeat the longest word.'
        ...
        parameter do
          ...
          key :in, :query
          key :description, 'Player number and name. If no players are added, the system will provide Non-player Characters'
          key :key_example, 'p1'
